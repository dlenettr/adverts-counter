...
$module = array(
	...
	'image'	=> "http://img.dle.net.tr/mws/adverts_counter.png",
...
if ( $_REQUEST['action'] == "install" ) {
	...
	$mod->file( ROOT_DIR. "/install/xml/adverts_counter.xml" );
	$db->query("ALTER TABLE " . PREFIX . "_banners ADD click_count TINYINT( 1 ) NOT NULL DEFAULT '0', ADD clicks MEDIUMINT( 11 ) NOT NULL DEFAULT '0', ADD click_link VARCHAR( 10 ) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL;");
	$mod->close();
...
HTML;
	...
	$db->query("ALTER TABLE " . PREFIX . "_banners DROP click_count, DROP clicks, DROP click_link;");
